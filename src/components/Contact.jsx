        ...
        <div className="flex flex-col gap-8">
          <div className="flex justify-center gap-8">
            <a
              ...
              className="flex flex-col items-center gap-2 p-4 rounded-md bg-blue-500 hover:bg-blue-600 transition duration-300 text-white w-32"
            >
            ...
            <a
              ...
              className="flex flex-col items-center gap-2 p-4 rounded-md bg-green-500 hover:bg-green-600 transition duration-300 text-white w-32"
            >
              <MdEmail size="30" />
